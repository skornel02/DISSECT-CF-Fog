package com.stormbots.pid_simulation;
 ...
 * </code>
 *
 * @see <a href="https://github.com/tekdemo/MiniPID-Java">SOURCE</a>
 * @see <a href="https://brettbeauregard.com/blog/2011/04/improving-the-beginners-pid-direction/improving-the-beginners-pid-introduction">PID</a>
 */
...
public class PidSimulator{
     ...
     */
    public PidSimulator(double p, double i, double d){
        P=p; I=i; D=d;
        checkSigns();
    }
     ...
     */
    public PidSimulator(double p, double i, double d, double f){
        P=p; I=i; D=d; F=f;
        checkSigns();
    }
     ...
     * @see PidSimulator#getOutput(double actual) <br>
     * @param setpoint
     */
