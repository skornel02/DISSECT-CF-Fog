...
export type SchemaComputerSpecification =
  components['schemas']['ComputerSpecification'];
export type SchemaRegionConnection = components['schemas']['RegionConnection'];
export type SchemaRegionSpecification =
  components['schemas']['RegionSpecification'];
export type SchemaSimulationStructure =
  components['schemas']['SimulationStructure'];
export type SchemaSimulationStartedDto =
...
export type SchemaSimulationStatusDto =
