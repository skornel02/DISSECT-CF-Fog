package hu.u_szeged.inf.fog.simulator.demo.regression;
...
/**
 * This is a copy of the IoTSimulationExample that only has 4 instances of the same virtual appliance.
 * <p>
 * When running this example only 99 tasks get executed, the last one is not executed.
 */
@SuppressWarnings("unused")
public class IoTWorkflowFourRegressionSimulation {
